...
if (wmm.matches) {
  hero.setAttribute("src", "./imagem/hero-desktop.png");
...
function featuresHandler(classString, event) {
  ...
  if (displayValue == "block") {
    event.target.setAttribute("src", "./imagem/icon-arrow-up.svg");
  } else {
    event.target.setAttribute("src", "./imagem/icon-arrow-down.svg");
  }
}